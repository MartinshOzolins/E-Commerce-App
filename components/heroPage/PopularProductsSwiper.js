          ...
          <SwiperSlide key={index} className="relative cursor-pointer">
            ...
            >
              ...
              <div className="w-full h-full flex flex-col items-center justify-end px-5 sm:px-2 md:px-5 pb-2 md:pb-3">
                ...
                <button className="text-sm sm:text-base bg-white text-blue-900 border border-blue-900 w-full py-1 rounded-md hover:bg-blue-900 hover:text-white transition duration-300">
                  SHOP NOW
                </button>
              </div>
            </Link>
